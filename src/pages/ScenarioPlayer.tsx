...
const labels = {
  el: {
    ...
    tried: 'Δοκίμασες',
    choices: 'επιλογές',
    noScore: 'Δεν υπάρχει βαθμολογία. Κάποιες επιλογές έχουν μεγαλύτερο ρίσκο από άλλες — δες τι κερδίζεις, τι ρισκάρεις και κάνε replay.',
    story: 'Ιστορία',
    of: 'από',
  },
  en: {
    ...
    tried: 'You tried',
    choices: 'choices',
    noScore: 'There is no score. Some choices carry more risk than others — notice what you gain, what you risk, and replay the moment.',
    story: 'Story',
    of: 'of',
  },
} as const;
